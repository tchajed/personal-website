  ...
  @body{
    ...
    @div[class: "intro container"]{
      @div[class: "bio"]{
        ...
        @p{Hello! I'm Tej Chajed, a fifth-year PhD student in @a[href:
          "https://pdos.csail.mit.edu/"]{PDOS} at MIT CSAIL, advised by Frans
      ...
      @img[class: "portrait" alt: "Tej Chajed picture" src: "assets/portrait.jpg" width: 250 height: 250]
    }
      ...
      @div[class: "pub-header container"]{
        @div{
          ...
          @span[class: "pub-conference"]{
            @abbr[title: "USENIX Symposium on Operating System Design and Implementation (OSDI 2018)"]{OSDI 2018}
          }
        }
        @div[class: "pub-links"]{
          @a[href: "papers/cspec:osdi18.pdf"]{
            @img[title: "Paper PDF" alt: "paper icon" src: "assets/file.svg" height: 16 width: 16]
          }
          @a[href: "papers/cspec:osdi18-slides.pdf"]{
            @img[title: "Slides" alt: "slides icon" src: "assets/slides.svg" height: 16 width: 16]
          }
        }
      }
